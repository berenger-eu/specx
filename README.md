...
Data can be send to target MPI processes using the `mpiSend` and `mpiRecv` methods of the `SpTaskGraph` object. For built-in and POD types these methods work automatically:
```cpp
